  ...
  return (
    <section className="py-32 bg-zinc-950 relative overflow-hidden">
      ...
      <div className="absolute inset-0" style={{ opacity: 0.4 }}>
        <div
          className="absolute inset-0 bg-[linear-gradient(to_right,transparent_0%,rgba(255,255,255,0.1)_15%,transparent_30%)] animate-[gradient-slide_4s_ease-in-out_infinite]"
          style={{ transform: "rotate(-45deg)", width: "200%", left: "-50%" }}
        />
        <div
          className="absolute inset-0 bg-[linear-gradient(to_right,transparent_0%,rgba(255,255,255,0.05)_25%,transparent_50%)] animate-[gradient-slide_7s_ease-in-out_infinite]"
          style={{ transform: "rotate(45deg)", width: "200%", left: "-50%" }}
        />
      </div>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8 relative">
          {steps.map((step, index) => (
            ...
            >
              ...
              <div
                className={`absolute -inset-x-20 -inset-y-10 bg-gradient-to-r ${step.gradient} opacity-0 group-hover:opacity-5 transition-opacity duration-500 blur-2xl`}
              />
              <div
                className={`absolute inset-0 rounded-2xl bg-gradient-to-br ${step.gradient} opacity-0 group-hover:opacity-10 transition-opacity duration-500`}
              />
              <div
                className={`absolute inset-0 bg-[radial-gradient(circle_at_50%_50%,rgba(var(--${step.glowColor}-glow),0.15),transparent_100%)] opacity-0 group-hover:opacity-100 transition-opacity duration-500`}
              />
              ...
              <div className="relative">
                ...
                <div className="relative transform group-hover:translate-z-10 transition-transform duration-500">
                  <span
                    className={`absolute blur-2xl opacity-50 text-6xl font-bold bg-gradient-to-br ${step.gradient} bg-clip-text text-transparent`}
                  >
                    {step.number}
                  </span>
                  <span
                    className={`relative text-6xl font-bold bg-gradient-to-br ${step.gradient} bg-clip-text text-transparent opacity-40 group-hover:opacity-60 transition-all duration-300 transform group-hover:scale-110`}
                  >
                    {step.number}
                  </span>
                </div>
                ...
                >
                  <div className="relative">
                    <step.icon
                      className={`w-6 h-6 text-${step.glowColor}-400 group-hover:text-${step.glowColor}-300 transition-colors duration-300`}
                    />
                    <div
                      className={`absolute inset-0 blur-md bg-${step.glowColor}-400/30 opacity-0 group-hover:opacity-100 transition-opacity duration-300`}
                    />
                  </div>
                </div>
                ...
                <h3
                  className={`text-2xl font-bold text-white mt-4 mb-4 group-hover:text-${step.glowColor}-300 transition-colors duration-300 transform group-hover:translate-x-1`}
                >
                  {step.title}
                </h3>
                ...
                {/* Replacing Image with Meaningful SVG */}
                <div
                ...
                >
                  <div className="relative h-48 flex items-center justify-center">
                    <svg
                      className={`w-24 h-24 text-${step.glowColor}-400 group-hover:text-${step.glowColor}-300 transition-colors duration-300`}
                      xmlns="http://www.w3.org/2000/svg"
                      fill="none"
                      viewBox="0 0 24 24"
                      stroke="currentColor"
                    >
                      {/* Example SVG Path for illustration */}
                ...
                <div className="mt-6 opacity-0 group-hover:opacity-100 transition-opacity duration-300 transform translate-y-2 group-hover:translate-y-0">
                  <button
                    className={`flex items-center space-x-2 text-${step.glowColor}-400 hover:text-${step.glowColor}-300 transition-colors duration-300`}
                  >
