          ...
          {demos.map((demo, index) => (
            ...
            >
              ...
              <div className="flex items-start gap-4 mb-6">
                <div
                  className={`p-3.5 rounded-xl ${demo.iconBg} transition-colors duration-500 relative`}
                >
                  <div
                    className={`absolute inset-0 rounded-xl ${demo.glowColor} blur-xl group-hover:blur-2xl transition-all duration-500 opacity-0 group-hover:opacity-100`}
                  />
                  <demo.icon
                    className={`w-6 h-6 ${demo.iconColor} relative z-10`}
                  />
                </div>
                <div>
                  <h3
                    className={`text-xl font-semibold text-white mb-1 ${demo.hoverTextColor} transition-colors duration-300`}
                  >
                    {demo.title}
                  </h3>
              ...
              <button
                ...
                className={`w-full py-4 px-6 rounded-xl bg-gradient-to-r ${demo.buttonGradient} ${demo.buttonHoverGradient} text-white shadow-lg hover:shadow-violet-500/25 transition-all duration-500 flex items-center justify-center gap-3 group-hover:scale-[1.02]`}
              >
